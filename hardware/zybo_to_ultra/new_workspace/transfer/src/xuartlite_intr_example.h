#ifndef UARTLITE_EXAMPLE_C
#define UARTLITE_EXAMPLE_C
...
// 		return XST_FAILURE;
// 	}
// 	xil_printf("UART self-test passed\r\n");
...
// 	xil_printf("UART interrupt enabled\r\n");
...
// 	xil_printf("UART receive started\r\n");
